...
//		
//		// Insert healthmessageexchange database into our mysql
//		try {
//			messageExchangeString = "CREATE DATABASE IF NOT EXISTS healthmessagesexchange /*!40100 DEFAULT CHARACTER SET utf8 */";
//			this.executeUpdate(connMessage, messageExchangeString);
////			System.out.println("Created database healthmessagesexchange");
//		} catch (SQLException e) {
//			System.out.println("ERROR: Could not create the database healthmessagesexchange");
//			e.printStackTrace();
//			return;
//		}
//		
//		// Use healthmessageexchange database
//		try {
//			messageExchangeString = "USE healthmessagesexchange";
//			this.executeUpdate(connMessage, messageExchangeString);
////			System.out.println("USE call succeeded");
//		} catch (SQLException e) {
//			System.out.println("ERROR: USE call failed");
//			e.printStackTrace();
//			return;
//		}
//		
...
////		try {
////			messageExchangeString = "DROP TABLE IF EXISTS 'messages'";
////			this.executeUpdate(conn, messageExchangeString);
//////			System.out.println("DROP TABLE IF EXISTS 'messages' succeeded");
////		} catch (SQLException e) {
////			System.out.println("ERROR: DROP TABLE IF EXISTS 'messages' failed");
////			e.printStackTrace();F
////			return;
////		}
//		
...
//			this.executeUpdate(connMessage, createTable);
////			System.out.println("CREATE TABLE 'messages' succeeded");
//		} catch (SQLException e) {
////			ifMessagesExist = true;
//			e.printStackTrace();
...
////			try {
////				messageExchangeString = "LOCK TABLES messages WRITE";
////				this.executeUpdate(conn, messageExchangeString);
////				//			System.out.println("LOCK TABLES 'messages' WRITE succeeded");
////			} catch (SQLException e) {
////				System.out.println("ERROR: LOCK TABLES 'messages' WRITE failed");
////				e.printStackTrace();
////				return;
////			}
////
